...
import { deleteProduct, deleteProductImage, getLatestProducts, getListings, getProductDetail, getProductsByCategory, listNewProduct, searchProducts, updateProduct } from "src/controllers/product";
...
productRouter.delete('/images/:productId/:imageId', isAuth, deleteProductImage)
